# CODE adapted from https://github.com/gongzhitaao/tensorflow-adversarial/blob/master/example/fgsm_mnist.py
...
plt.savefig('img/fgsm_mnist_simple.png')

print('\nFINISHED running FGMT MNIST for SIMPLE')
